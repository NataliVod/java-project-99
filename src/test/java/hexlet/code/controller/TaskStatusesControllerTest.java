...
public class TaskStatusesControllerTest {
    ...
    public void testShow() throws Exception {
        ...
        var request = MockMvcRequestBuilders.get("/api/task_statuses/{id}", testTaskStatus.getId()).with(jwt());
    ...
    public void testUpdate() throws Exception {
        ...
        var request = MockMvcRequestBuilders.put("/api/task_statuses/{id}", testTaskStatus.getId()).with(jwt())
                .contentType(MediaType.APPLICATION_JSON)
                .content(om.writeValueAsString(dto));
    ...
    public void testPartialUpdate() throws Exception {
        ...
        var request = MockMvcRequestBuilders.put("/api/task_statuses/{id}", testTaskStatus.getId())
                .with(jwt())
                .contentType(MediaType.APPLICATION_JSON)
                .content(om.writeValueAsString(dto));
    ...
    public void testDestroy() throws Exception {
        taskStatusRepository.save(testTaskStatus);
        var request = MockMvcRequestBuilders.delete("/api/task_statuses/{id}", testTaskStatus.getId()).with(jwt());
        mockMvc.perform(request)
                .andExpect(status().isOk());
